...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-task-sound': { kind: 'none', reason: 'Browser-side settings row and completion chime; plays audio for a human and registers nothing model-facing.' },
